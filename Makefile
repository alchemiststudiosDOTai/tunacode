...
test:
	venv/bin/python -m pytest -q tests/characterization tests/utility tests/test_security.py tests/test_agent_output_formatting.py tests/test_prompt_changes_validation.py
