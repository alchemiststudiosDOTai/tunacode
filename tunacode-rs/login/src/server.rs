...
use tunacode_core::default_client::originator;
use tunacode_core::token_data::TokenData;
use tunacode_core::token_data::parse_id_token;
use rand::RngCore;
...
impl ServerOptions {
    pub fn new(tunacode_home: PathBuf, client_id: String) -> Self {
        Self {
            tunacode_home,
            client_id,
...
fn build_authorize_url(
    ...
    let query = vec![
        ...
        ("tunacode_cli_simplified_flow", "true"),
        ("state", state),
...
pub(crate) async fn persist_tokens_async(
    ...
    let tunacode_home = tunacode_home.to_path_buf();
    tokio::task::spawn_blocking(move || {
        ...
        tunacode_core::auth::write_auth_json(&auth_file, &auth)
    })
    .await
