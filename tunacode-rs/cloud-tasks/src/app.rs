...
pub struct EnvironmentRow {
    ...
    pub is_pinned: bool,
    pub repo_hints: Option<String>, // e.g., "openai/tunacode"
}
...
pub struct AttemptView {
    ...
    pub status: tunacode_cloud_tasks_client::AttemptStatus,
...
pub enum AppEvent {
    ...
    DetailsMessagesLoaded {
        ...
        attempt_status: tunacode_cloud_tasks_client::AttemptStatus,
    },
    DetailsFailed {
        id: TaskId,
        title: String,
    ...
    AttemptsLoaded {
        id: TaskId,
        attempts: Vec<tunacode_cloud_tasks_client::TurnAttempt>,
    },
    /// Background completion of new task submission
    NewTaskSubmitted(Result<tunacode_cloud_tasks_client::CreatedTask, String>),
    ...
    ApplyFinished {
        id: TaskId,
        result: std::result::Result<tunacode_cloud_tasks_client::ApplyOutcome, String>,
    },
}
...
mod tests {
    ...
    impl tunacode_cloud_tasks_client::CloudBackend for FakeBackend {
        async fn list_tasks(
            &self,
            env: Option<&str>,
        ) -> tunacode_cloud_tasks_client::Result<Vec<TaskSummary>> {
            ...
            for (i, t) in titles.into_iter().enumerate() {
                out.push(TaskSummary {
                    ...
                    title: t.to_string(),
                    status: tunacode_cloud_tasks_client::TaskStatus::Ready,
                    updated_at: Utc::now(),
                    environment_id: env.map(str::to_string),
                    environment_label: None,
                    summary: tunacode_cloud_tasks_client::DiffSummary::default(),
                    is_review: false,
        ...
        async fn get_task_diff(
            &self,
            _id: TaskId,
        ) -> tunacode_cloud_tasks_client::Result<Option<String>> {
        ...
        async fn get_task_messages(
            &self,
            _id: TaskId,
        ) -> tunacode_cloud_tasks_client::Result<Vec<String>> {
            Ok(vec![])
        }
        async fn get_task_text(
            &self,
            _id: TaskId,
        ) -> tunacode_cloud_tasks_client::Result<tunacode_cloud_tasks_client::TaskText> {
            Ok(tunacode_cloud_tasks_client::TaskText {
                prompt: Some("Example prompt".to_string()),
                messages: Vec::new(),
                turn_id: Some("fake-turn".to_string()),
                sibling_turn_ids: Vec::new(),
                attempt_placement: Some(0),
                attempt_status: tunacode_cloud_tasks_client::AttemptStatus::Completed,
            })
        }
        ...
        async fn create_task(
            ...
            _qa_mode: bool,
            _best_of_n: usize,
        ) -> tunacode_cloud_tasks_client::Result<tunacode_cloud_tasks_client::CreatedTask> {
            Err(tunacode_cloud_tasks_client::CloudTaskError::Unimplemented(
                "not used in test",
            ))
        }
