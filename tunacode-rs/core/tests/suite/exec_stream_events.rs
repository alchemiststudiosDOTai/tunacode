...
use tunacode_core::protocol::ExecCommandOutputDeltaEvent;
use tunacode_core::protocol::ExecOutputStream;
...
async fn test_exec_timeout_returns_partial_output() {
    ...
    let Err(tunacodeErr::Sandbox(SandboxErr::Timeout { output })) = result else {
