...
pub(crate) fn get_model_info(model_family: &ModelFamily) -> Option<ModelInfo> {
    ...
    match slug {
        ...
        // https://platform.openai.com/docs/models/tunacode-mini-latest
        "tunacode-mini-latest" => Some(ModelInfo::new(200_000, 100_000)),
        ...
        _ if slug.starts_with("gpt-5-tunacode") => Some(ModelInfo {
        ...
        _ if slug.starts_with("tunacode-") => Some(ModelInfo::new(272_000, 128_000)),
