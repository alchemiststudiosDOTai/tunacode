...
const GPT_5_TUNACODE_INSTRUCTIONS: &str = include_str!("../gpt_5_tunacode_prompt.md");
...
pub fn find_family_for_model(slug: &str) -> Option<ModelFamily> {
    ...
    } else if slug.starts_with("tunacode-mini-latest") {
        model_family!(
            slug, "tunacode-mini-latest",
            supports_reasoning_summaries: true,
    ...
    } else if slug.starts_with("tunacode-") || slug.starts_with("gpt-5-tunacode") {
        model_family!(
            slug, slug,
            supports_reasoning_summaries: true,
            reasoning_summary_format: ReasoningSummaryFormat::Experimental,
            base_instructions: GPT_5_TUNACODE_INSTRUCTIONS.to_string(),
        )
