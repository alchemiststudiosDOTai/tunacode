...
//!
//! The [`McpConnectionManager`] owns one [`tunacode_mcp_client::McpClient`] per
            ...
            join_set.spawn(async move {
                ...
                let params = mcp_types::InitializeRequestParams {
                    ...
                    client_info: Implementation {
                        ...
                        title: Some("tunacode".into()),
                        // This field is used by tunacode when it is an MCP
                        // server: it should not be used when tunacode is
                        // an MCP client.
                        user_agent: None,
                    },
