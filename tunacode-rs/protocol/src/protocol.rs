//! Defines the protocol for a tunacode session between a client and an agent.
//!
...
pub const USER_MESSAGE_BEGIN: &str = "## My request for tunacode:";
...
pub enum Op {
    ...
    /// for a turn of a [`crate::tunacode_conversation::tunacodeConversation`].
    UserTurn {
        /// User input items, see `InputItem`
        items: Vec<InputItem>,
    ...
    /// Request to shut down tunacode instance.
    Shutdown,
}

/// Determines the conditions under which the user is consulted to approve
/// running the command proposed by tunacode.
