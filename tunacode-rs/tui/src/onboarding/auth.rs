...
impl AuthModeWidget {
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "  ".into(),
                "Sign in with ChatGPT to use tunacode as part of your paid plan".into(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant tunacode".into(),
            Line::from(vec![
                "  For more details see the ".into(),
                "\u{1b}]8;;https://github.com/openai/tunacode\u{7}tunacode docs\u{1b}]8;;\u{7}".underlined(),
            ])
            .dim(),
            "".into(),
            "  tunacode can make mistakes".into(),
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  tunacode will use usage-based billing with your API key.".into(),
        ];
    ...
    fn save_api_key(&mut self, api_key: String) {
        match login_with_api_key(&self.tunacode_home, &api_key) {
            Ok(()) => {
                self.error = None;
    ...
    fn start_chatgpt_login(&mut self) {
        ...
        self.error = None;
        let opts = ServerOptions::new(self.tunacode_home.clone(), CLIENT_ID.to_string());
