...
use tunacode_core::protocol::AgentReasoningRawContentDeltaEvent;
use tunacode_core::protocol::AgentReasoningRawContentEvent;
use tunacode_core::protocol::ApplyPatchApprovalRequestEvent;
use tunacode_core::protocol::BackgroundEventEvent;
...
use tunacode_core::protocol::ExecCommandBeginEvent;
use tunacode_core::protocol::ExecCommandEndEvent;
use tunacode_core::protocol::ExitedReviewModeEvent;
use tunacode_core::protocol::InputItem;
use tunacode_core::protocol::InputMessageKind;
use tunacode_core::protocol::ListCustomPromptsResponseEvent;
use tunacode_core::protocol::McpListToolsResponseEvent;
use tunacode_core::protocol::McpToolCallBeginEvent;
use tunacode_core::protocol::McpToolCallEndEvent;
use tunacode_core::protocol::Op;
use tunacode_core::protocol::PatchApplyBeginEvent;
...
use tunacode_core::protocol::TokenUsageInfo;
use tunacode_core::protocol::TurnAbortReason;
use tunacode_core::protocol::TurnDiffEvent;
use tunacode_core::protocol::UserMessageEvent;
...
use chrono::Local;
use tunacode_common::approval_presets::ApprovalPreset;
use tunacode_common::approval_presets::builtin_approval_presets;
use tunacode_common::model_presets::ModelPreset;
use tunacode_common::model_presets::builtin_model_presets;
...
use tunacode_git_tooling::CreateGhostCommitOptions;
use tunacode_git_tooling::GhostCommit;
use tunacode_git_tooling::GitToolingError;
use tunacode_git_tooling::create_ghost_commit;
use tunacode_git_tooling::restore_ghost_commit;
...
pub(crate) struct ChatWidget {
    ...
    tunacode_op_tx: UnboundedSender<Op>,
...
impl ChatWidget {
    ...
    fn on_session_configured(&mut self, event: tunacode_core::protocol::SessionConfiguredEvent) {
        self.bottom_pane
        ...
        // Ask tunacode-core to enumerate custom prompts for this session.
    ...
    fn on_plan_update(&mut self, update: tunacode_core::plan_tool::UpdatePlanArgs) {
    ...
    fn on_exec_command_output_delta(
        &mut self,
        _ev: tunacode_core::protocol::ExecCommandOutputDeltaEvent,
    ) {
    ...
    fn on_patch_apply_end(&mut self, event: tunacode_core::protocol::PatchApplyEndEvent) {
        let ev2 = event.clone();
        self.defer_or_handle(
    ...
    fn on_get_history_entry_response(
        &mut self,
        event: tunacode_core::protocol::GetHistoryEntryResponseEvent,
    ) {
        let tunacode_core::protocol::GetHistoryEntryResponseEvent {
            offset,
            log_id,
            entry,
        } = event;
    ...
    pub(crate) fn handle_patch_apply_end_now(
        &mut self,
        event: tunacode_core::protocol::PatchApplyEndEvent,
    ) {
    ...
    pub(crate) fn new_from_existing(
        common: ChatWidgetInit,
        conversation: std::sync::Arc<tunacode_core::tunacodeConversation>,
        session_configured: tunacode_core::protocol::SessionConfiguredEvent,
    ) -> Self {
        let ChatWidgetInit {
            config,
            frame_requester,
    ...
    fn dispatch_command(&mut self, cmd: SlashCommand) {
        ...
        match cmd {
            ...
            SlashCommand::Compact => {
                ...
                self.app_event_tx.send(AppEvent::TunacodeOp(Op::Compact));
            }
            SlashCommand::Review => {
            ...
            SlashCommand::Logout => {
                if let Err(e) = tunacode_core::auth::logout(&self.config.tunacode_home) {
            ...
            Err(err) => {
                ...
                let (message, hint) = match &err {
                    ...
                    _ => (
                        ...
                        Some(
                            "Restart tunacode after resolving the issue to re-enable snapshots."
                                .to_string(),
                        ),
                    ),
                };
    ...
    pub(crate) fn handle_tunacode_event(&mut self, event: Event) {
    ...
    fn dispatch_event_msg(&mut self, id: Option<String>, msg: EventMsg, from_replay: bool) {
        match msg {
            ...
            _ => {
                tracing::trace!("handle_tunacode_event: {:?}", msg);
            }
        }
    ...
    pub(crate) fn open_model_popup(&mut self) {
        ...
        for preset in presets.iter() {
            ...
            let actions: Vec<SelectionAction> = vec![Box::new(move |tx| {
                tx.send(AppEvent::TunacodeOp(Op::OverrideTurnContext {
                    cwd: None,
        ...
        self.bottom_pane.show_selection_view(SelectionViewParams {
            ...
            subtitle: Some(
                "Switch between OpenAI models for this and future tunacode CLI session".to_string(),
            ),
    ...
    /// Forward an `Op` directly to tunacode.
    pub(crate) fn submit_op(&self, op: Op) {
        // Record outbound operation for session replay fidelity.
        crate::session_log::log_outbound_op(&op);
        if let Err(e) = self.tunacode_op_tx.send(op) {
        ...
        items.push(SelectionItem {
            ...
            actions: vec![Box::new(
                move |tx: &AppEventSender| {
                    tx.send(AppEvent::TunacodeOp(Op::Review {
        ...
        for option in branches {
            ...
            items.push(SelectionItem {
                ...
                actions: vec![Box::new(move |tx3: &AppEventSender| {
                    tx3.send(AppEvent::TunacodeOp(Op::Review {
                        review_request: ReviewRequest {
                            prompt: format!(
    ...
    pub(crate) async fn show_review_commit_picker(&mut self, cwd: &Path) {
        let commits = tunacode_core::git_info::recent_commits(cwd, 100).await;
...
pub(crate) fn show_review_commit_picker_with_entries(
    chat: &mut ChatWidget,
    entries: Vec<tunacode_core::git_info::CommitLogEntry>,
) {
