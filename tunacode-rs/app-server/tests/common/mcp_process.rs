...
use tunacode_protocol::mcp_protocol::ClientNotification;
use tunacode_protocol::mcp_protocol::GetAuthStatusParams;
use tunacode_protocol::mcp_protocol::InitializeParams;
...
impl McpProcess {
    ...
    pub async fn new_with_env(
        ...
        let std_cmd = StdCommand::cargo_bin("tunacode-app-server")
    ...
    pub async fn initialize(&mut self) -> anyhow::Result<()> {
        let params = Some(serde_json::to_value(InitializeParams {
            client_info: ClientInfo {
                name: "tunacode-app-server-tests".to_string(),
                title: None,
