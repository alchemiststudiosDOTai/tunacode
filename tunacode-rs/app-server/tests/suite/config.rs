...
use tunacode_protocol::mcp_protocol::Profile;
use tunacode_protocol::mcp_protocol::SandboxSettings;
...
fn create_config_toml(tunacode_home: &Path) -> std::io::Result<()> {
...
async fn get_config_toml_parses_all_fields() {
    ...
    create_config_toml(tunacode_home.path()).expect("write config.toml");
    ...
    let expected = GetUserSavedConfigResponse {
        config: UserSavedConfig {
            ...
            model: Some("gpt-5-tunacode".into()),
