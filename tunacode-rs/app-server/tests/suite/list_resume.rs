...
async fn test_list_and_resume_conversations() {
    // Prepare a temporary tunacode_HOME with a few fake rollout files.
    ...
    // Expect a tunacode/event notification with msg.type == sessionConfigured
...
fn create_fake_rollout(tunacode_home: &Path, filename_ts: &str, meta_rfc3339: &str, preview: &str) {
