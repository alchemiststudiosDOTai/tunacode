...
impl OtelEventManager {
    ...
    pub fn conversation_starts(
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "tunacode.conversation_starts",
        ...
        Fut: Future<Output = Result<Response, Error>>,
    {
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "tunacode.api_request",
            event.timestamp = %timestamp(),
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
            auth_mode = self.metadata.auth_mode,
    ...
    pub fn user_prompt(&self, items: &[InputItem]) {
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "tunacode.user_prompt",
            event.timestamp = %timestamp(),
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
            auth_mode = self.metadata.auth_mode,
    ...
    pub fn tool_decision(
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "tunacode.tool_decision",
            event.timestamp = %timestamp(),
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
            auth_mode = self.metadata.auth_mode,
        ...
        E: Display,
    {
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "tunacode.tool_result",
            event.timestamp = %timestamp(),
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
            auth_mode = self.metadata.auth_mode,
