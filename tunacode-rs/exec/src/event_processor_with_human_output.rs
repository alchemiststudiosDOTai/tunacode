...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(&mut self, config: &Config, prompt: &str, _: &SessionConfiguredEvent) {
        ...
        ts_println!(
            self,
            "OpenAI tunacode v{} (research preview)\n--------",
            VERSION
        );
    ...
    fn process_event(&mut self, event: Event) -> TunacodeStatus {
        ...
        match msg {
            ...
            EventMsg::TaskComplete(TaskCompleteEvent { last_agent_message }) => {
                ...
                return TunacodeStatus::InitiateShutdown;
            }
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_println!(
                    self,
                    "{} {}",
                    "tunacode session".style(self.magenta).style(self.bold),
            ...
            EventMsg::ShutdownComplete => return TunacodeStatus::Shutdown,
            EventMsg::ConversationPath(_) => {}
            EventMsg::UserMessage(_) => {}
            EventMsg::EnteredReviewMode(_) => {}
            EventMsg::ExitedReviewMode(_) => {}
        }
        TunacodeStatus::Running
    }
}
