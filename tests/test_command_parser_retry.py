...
class TestCommandParserRetry:
    ...
    def test_retry_failure_falls_back_to_concatenation_check(self, mock_retry):
        ...
        mock_retry.side_effect = json.JSONDecodeError("Expecting ',' delimiter: line 1 column 15 (char 14): Extra data", "", 14)
...
class TestRealWorldScenarios:
    ...
    def test_common_concatenation_pattern(self):
        ...
        concatenated_args = '{"filepath": "main.py"}{"filepath": "__init__.py"}{"filepath": "cli/main.py"}'
