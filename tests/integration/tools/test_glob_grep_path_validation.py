"""Tests for glob and grep path validation with ToolRetryError.
...
class TestGlobPathValidation:
    ...
    async def test_nonexistent_directory_raises_tool_retry_error(self, tmp_path):
    ...
    async def test_file_path_instead_of_directory_raises_tool_retry_error(self, tmp_path):
